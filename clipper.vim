...
syn keyword clipperType         STRING NUMERIC LOGIC DATE
syn keyword clipperType         ARRAY HASH CODEBLOCK OBJECT SYMBOL UNDEFINED

syn keyword clipperStatement    FORCE CLASS CONSTRUCTOR METHOD THREADSAFE THIS
